...
[_COLEMAK] = LAYOUT_ortho_4x12( \
  ...
  =,     KC_LGUI, LOWER  , KC_LALT, KC_SPC, KC_SPC,  KC_SPC,  KC_SPC,   RAISE,   KC_RALT, KC_LANG1 ,ADJUST
    ),
 ...
 */
 [_ADJUST] = LAYOUT_ortho_4x12(
     ...
     KC_PSCREEN,_______, _______, _______, _______, AG_NORM, AG_SWAP, QWERTY,  COLEMAK, _______, _______, _______,
